...
function multiply(a, b) { //eslint-disable-line
 var product = a * b; 
 var theMessage = 'The product of ' + a + ' and '  + b + ' is ' + product + '.'

 return [product, theMessage];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
 var add = sum (a, b)
 var addAgain = sum (add[0], c) 
 var times = multiply (a, b)
 var timeTime = multiply (times[0], c)
 var mess1 = a + ' and ' + b + ' and ' + c + ' sum to ' + addAgain[0] + '.'
 var mess2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + timeTime[0] + '.'
 console.log(addAgain[0], timeTime[0], mess1, mess2)
 return [addAgain[0], timeTime[0], mess1, mess2 ]
